...
const MyBookings = () => {
  ...
  return (
    <div className="py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
      <Title
        title="my bookings"
        subTitle="Easily Manage your Past
      Current and Upcoming hotel reservation in once place. Plan your trips seamlessly with 
      just a few clicks"
        align="left"
      />
      ...
      <div className="max-w-6xl mt-8 w-full text-gray-800">
        <div className="hidden md:grid grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 font-medium text-base py-3">
          ...
          <div className="w-1/3">Dat and Timing</div>
