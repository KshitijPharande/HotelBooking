...
const Dashboard = () => {
  ...
  return (
    <div>
      ...
      subTitle='Monitor your roo listings, track bookings and analyze revenue-all in one place.Stay updated with real-time insights to ensure smooth operations.'/>
      ...
      {/* Recent Bookings */}
      <h2 className='text0xk text-blue-950/70 font-medium mb-5'>Recent Bookings</h2>
      <div className='w-full max-w-3xl text-left border-gray-300 rounded-lg max-h-80 overflow-y-scroll '></div>
